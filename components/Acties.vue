<template>
  <section class="py-1 bg-white-800" id="actie">
    <div class="container max-w-5xl m-8 mx-auto">
      <h1 class="w-full my-1 text-3xl font-bold leading-tight text-center md:text-3xl lg:text-5xl text-gray">
        Introductie actie
      </h1>
      ...
      <actie-left
        ...
        content="Als kennismakingstarief bied ik U een uitgebreide basisbehandeling aan van uw voeten, inclusief eelt, nagelriemen behandeling, een likdoorn, en max. 4 kalknagels, <strong>voor de prijs van € 22,95 *</strong>.<br>Ik neem hierbij alle tijd voor uw voeten en ga niet weg voordat ze weer als van een pasgeboren baby zijn.
      ...
      <div class="mx-auto text-sm italic text-center text-gray">
        * Maximale behandeltijd 2 uur
      </div>
    </div>
  </section>
</template>
