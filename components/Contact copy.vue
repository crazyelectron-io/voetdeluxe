          ...
          <div class="w-full flex rounded-md shadow-md">
            <div class="relative flex-grow focus-within:z-10">
              ...
              <input
                ...
                pattern="^(?:0|\(?\+31\)?\s?|0031\s?)[1-79](?:[\.\-\s]?\d\d){4}$"
                class="bg-white z-0 pl-10 placeholder-gray-200 shadow-md focus:placeholder-gray-100"
              />
            </div>
          </div>
          <div class="w-full flex rounded-md">
            <div class="relative flex-grow focus-within:z-10">
              ...
              <textarea
                ...
                class="form-textarea font-medium text-md bg-white z-0 pl-10 text-gray-500 placeholder-gray-200 shadow-md focus:placeholder-gray-100"
              />
            </div>
          </div>
          <div class="flex items-center px-10 relative">
            <input id="terms-and-privacy" name="terms-and-privacy" type="checkbox" required class="" />
