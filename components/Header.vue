<template>
  ...
  >
    ...
    >
      <button
        @click="drawer"
        class="flex w-full justify-between pr-4 h-16 my-1 pl-2 text-orange focus:outline-none hover:text-blue focus:text-gray"
      >
        <svg
          class="h-12 w-12"
          fill="none"
      ...
      <span
        @click="isOpen = false"
        class="flex items-center p-2 pl-6 text-lg font-semibold text-orange hover:bg-orange hover:text-white w-full"
      >
        <span class="mr-2">
          <svg
            fill="none"
      ...
      <div class="fixed bottom-0 w-full">
        ...
        <span
          ...
          class="flex items-center p-2 pl-6 text-lg font-semibold text-orange hover:bg-orange hover:text-white w-full"
        >
              <svg class="h-7 w-7 mr-2" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
