<template>
  <footer class="bg-gray-400">
    <hr class="border-t-2 border-blue-500 my-0 py-0" />
      ...
      <div class="w-full flex flex-col md:flex-row py-4">
        <div class="max-w-7xl mx-auto py-6 px-4 overflow-hidden sm:px-6 lg:px-8">
          ...
          <nav class="-mx-5 -my-2 flex flex-wrap justify-center">
            <div class="px-5 py-2">
              <a to="#" class="text-base text-white-500 hover:text-orange-500">
                About
              </a>
            </div>
            <div class="px-5 py-2">
              <a href="#" class="text-base text-white-500 hover:text-orange-500">
                Blog
              </a>
            </div>
            <div class="px-5 py-2">
          ...
          <div class="mt-8 flex justify-center space-x-6">
            <a href="#" class="text-white-500 hover:text-orange-500">
